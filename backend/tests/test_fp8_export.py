...
The expensive half of this feature runs on a rented pod on a 26 GB checkpoint,
so the only honest proof available here is a SYNTHETIC checkpoint round-tripped
